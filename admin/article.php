    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="article.php"  enctype="multipart/form-data">
        	<label style="font-weight:bolder;">Article Title</label>
        	<input type="text" name="title" class="form-control mt-3" placeholder="Article Title" >
        	<textarea class="form-control mt-3" placeholder="Enter Article Content" name="content">Article Content</textarea>
