...
<a href='https://twitter.com/intent/tweet?url=link_to_be_shared'><i class='fa-brands fa-twitter-square'></i></a>
   ...
   rel='noopener'><i class='fa-brands fa-instagram-square'></i></a>
      <a href='https://wa.me/?text=urlencodedtext'><i class='fa fa-whatsapp'></i></a>

      <a href="https://developer.linkedin.com/docs/share-on-linkedin"><i class="fa-brands fa-linkedin"></i></a>
 ...
 <div class="col-lg-3 col-sm-6 col-md-4 col-xs-12">
  ...
  <div class="">
   ...
   <form method="post" action="contact.php">
    ...
    <br>
    <input style="width:300%;height: 50px;border-radius: 5px;outline: none;background-color: #FAFAFA;" type="text" name="name" required>
    <br>
    <br>
    <label style="font-weight:bolder;">Email</label>
    <br>
    <input style="width:300%;height: 50px;border-radius: 5px;outline: none;background-color: #FAFAFA;" type="email" name="email" required>
    <br>
    <br>
    <label style="font-weight:bolder;">Subject</label>
    <br>
    <input style="width:300%;height: 50px;border-radius: 5px;outline: none;background-color: #FAFAFA;" type="text" name="subject" required>
    <br>
    <br>
...
<br>
  ...
  <div>
    ...
    <br>
    <a class='a2'  style='text-align:left;color:orange;' href='comments.php'>Leave a comment/by Planet</a>
    <p>$partcontent</p>
    <br>
...
<button style="background-color: darkorange;border-radius: 20px;border-color: orange;"><a style="color: white;text-decoration: none;" href="contact.php">LEARN MORE</a></button></div>
</div>
